...
cp -f api_server/prodapi_Dockerfile leaf-master/src/server/prodapi_Dockerfile
...
mkdir leaf-master/src/ui-client/certs/
mkdir leaf-master/src/ui-client/certs/private/

## web server
cp -f certs/* leaf-master/src/ui-client/certs/
cp -f private/* leaf-master/src/ui-client/certs/private/
